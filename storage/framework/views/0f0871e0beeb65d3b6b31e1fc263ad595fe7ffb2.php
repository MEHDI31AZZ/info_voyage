...
<head>
    ...
    <link href="http://localhost/info_voyage/resources/css/style.css" rel="stylesheet">
    </head>
<body>
...
<p class="text-grey pb-md-5" style="text-align: center";>Besoin d'un visa ou non, besoin d'informations sur votre prochaine destination ? </p>

<div class="header-form col-11 col-md-8 col-xl-6">
                            <div class="blue-gradient rounded">
                                <div class="well well-green rounded">

                                    <div class="formfield-select large">
                                        <div class="select-container d-flex">
      
                                            <label for="GroupDropDownListDestination" class="sr-only">Destination</label>
                                            <select name="GroupDropDownListDestination" onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;GroupDropDownListDestination\&#39;,\&#39;\&#39;)&#39;, 0)" id="GroupDropDownListNationalite" class="country-list">
	<option selected="selected" value="Choisissez votre destination">Choisissez votre nationalité</option>
	<option value="11">France</option>
    <option value="22">ALGERIE</option>
    <option value="33">MAROC</option>
    <option value="44">CAMEROUN</option>
    </select>
    <select name="GroupDropDownListDestination" onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;GroupDropDownListDestination\&#39;,\&#39;\&#39;)&#39;, 0)" id="GroupDropDownListDestination" class="country-list">
    
    <option selected="selected" value="Choisissez votre destination">Choisissez votre destination</option>
	<optgroup label="Les destinations « tendances »">
	<option value="55">Vietnam</option>
    <option value="66">Russie</option>
    <option value="77">Chine</option>
    <option value="88">Canada</option>
    </select>



    <div class="nav-link btn-nav">
  <button type="button" onclick="window.location.href = 'http://localhost/info_voyage/resources/views/fr_vit.php';" id="btnSubmit" class="nav-link btn-nav" >Validez</button>
</div>
    </div>
    <p class="font_8" style="font-size:15px">​</span></p>
    <img src="http://localhost/info_voyage/resources/views/2.jpg" alt="cuba" style="width:700px;height:321px;object-fit:cover;object-position:50% 50%"/>
</div>
</div>
</div>
</div>
      ...
      <div class="container">
         <div class="row">
            <div class="col-12 col-md-8 mx-auto text-center">
               <h2 class="px-md-7"><a id="reopening">Mesures sanitaires mises<br> en place dans les consulats et les airoports</h2>
               <a href="http://localhost/info_voyage/resources/views/mesures.php" class="my-5 btn btn-primary btn-xl-tls">CLIQUEZ ICI</a>
...
<ul class="list-unstyled quick-links">
	...
	<li><a class="font-weight-normal" href="http://localhost:8000/" ><span style="color:null;">Politique de confidentialité</span></a></li>
...
<?php /**PATH C:\xampp\htdocs\info_voyage\resources\views/welcome.blade.php ENDPATH**/ ?>